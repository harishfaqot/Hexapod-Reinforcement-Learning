...
nexabots_root = os.path.abspath(os.path.join(os.path.dirname(__file__),"..", "..", ".."))
if nexabots_root not in sys.path:
    sys.path.insert(0, nexabots_root)
...
if __name__=="__main__":
    ...
    env_list = ["tiles"] #  ["flat", "tiles", "triangles", "holes", "pipe", "stairs", "stairs_down", "perlin"]
